...
const getStores = () => {
  const stores = (0, import_index_19ef195d.g)("__svelte__");
  return {
    page: {
...
const Header = (0, import_index_19ef195d.c)(($$result, $$props, $$bindings, slots) => {
  let $page, $$unsubscribe_page;
  $$unsubscribe_page = (0, import_index_19ef195d.a)(page, (value) => $page = value);
  $$result.css.add(css$1);
  $$unsubscribe_page();
  return `<header class="${"svelte-t2wq17"}"><div class="${"corner svelte-t2wq17"}"><a href="${"https://kit.svelte.dev"}" class="${"svelte-t2wq17"}"><img${(0, import_index_19ef195d.b)("src", logo, 0)} alt="${"SvelteKit"}" class="${"svelte-t2wq17"}"></a></div>
...
const _layout = (0, import_index_19ef195d.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${(0, import_index_19ef195d.v)(Header, "Header").$$render($$result, {}, {}, {})}
