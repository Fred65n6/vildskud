...
function writable(value, start = import_index_19ef195d.n) {
  let stop;
  const subscribers = /* @__PURE__ */ new Set();
  function set(new_value) {
    if ((0, import_index_19ef195d.d)(value, new_value)) {
      value = new_value;
      if (stop) {
  ...
  function subscribe2(run, invalidate = import_index_19ef195d.n) {
    const subscriber = [run, invalidate];
    subscribers.add(subscriber);
    if (subscribers.size === 1) {
      stop = start(set) || import_index_19ef195d.n;
    }
    run(value);
    return () => {
...
function spring(value, opts = {}) {
  ...
  function set(new_value, opts2 = {}) {
    ...
    if (value == null || opts2.hard || spring2.stiffness >= 1 && spring2.damping >= 1) {
      cancel_task = true;
      last_time = (0, import_index_19ef195d.f)();
    ...
    if (!task) {
      last_time = (0, import_index_19ef195d.f)();
      cancel_task = false;
      task = (0, import_index_19ef195d.l)((now2) => {
        if (cancel_task) {
          cancel_task = false;
          task = null;
          return false;
...
const Counter = (0, import_index_19ef195d.c)(($$result, $$props, $$bindings, slots) => {
  let offset;
  let $displayed_count, $$unsubscribe_displayed_count;
  let count = 0;
  const displayed_count = spring();
  $$unsubscribe_displayed_count = (0, import_index_19ef195d.a)(displayed_count, (value) => $displayed_count = value);
  ...
  return `<div class="${"counter svelte-sx9eo4"}"><button aria-label="${"Decrease the counter by one"}" class="${"svelte-sx9eo4"}"><svg aria-hidden="${"true"}" viewBox="${"0 0 1 1"}" class="${"svelte-sx9eo4"}"><path d="${"M0,0.5 L1,0.5"}" class="${"svelte-sx9eo4"}"></path></svg></button>
	...
	<div class="${"counter-viewport svelte-sx9eo4"}"><div class="${"counter-digits svelte-sx9eo4"}" style="${"transform: translate(0, " + (0, import_index_19ef195d.e)(100 * offset) + "%)"}"><strong class="${"hidden svelte-sx9eo4"}" aria-hidden="${"true"}">${(0, import_index_19ef195d.e)(Math.floor($displayed_count + 1))}</strong>
			<strong class="${"svelte-sx9eo4"}">${(0, import_index_19ef195d.e)(Math.floor($displayed_count))}</strong></div></div>
...
const Routes = (0, import_index_19ef195d.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
...
<section class="${"svelte-mjk9ig"}"><h1 class="${"svelte-mjk9ig"}"><div class="${"welcome svelte-mjk9ig"}"><picture><source srcset="${"svelte-welcome.webp"}" type="${"image/webp"}">
	...
	${(0, import_index_19ef195d.v)(Counter, "Counter").$$render($$result, {}, {}, {})}
</section>`;
});
