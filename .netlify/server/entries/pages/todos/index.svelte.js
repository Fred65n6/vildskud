...
var import_index_19ef195d = require("../../../chunks/index-19ef195d.js");
...
const Todos = (0, import_index_19ef195d.c)(($$result, $$props, $$bindings, slots) => {
  let { todos } = $$props;
...
<div class="${"todos svelte-16nsat"}"><h1>Todos</h1>
	...
	${(0, import_index_19ef195d.h)(todos, (todo) => {
    return `<div class="${["todo svelte-16nsat", todo.done ? "done" : ""].join(" ").trim()}"><form action="${"/todos?_method=PATCH"}" method="${"post"}"><input type="${"hidden"}" name="${"uid"}"${(0, import_index_19ef195d.b)("value", todo.uid, 0)} class="${"svelte-16nsat"}">
				<input type="${"hidden"}" name="${"done"}"${(0, import_index_19ef195d.b)("value", todo.done ? "" : "true", 0)} class="${"svelte-16nsat"}">
				<button class="${"toggle svelte-16nsat"}" aria-label="${"Mark todo as " + (0, import_index_19ef195d.e)(todo.done ? "not done" : "done")}"></button></form>

			<form class="${"text svelte-16nsat"}" action="${"/todos?_method=PATCH"}" method="${"post"}"><input type="${"hidden"}" name="${"uid"}"${(0, import_index_19ef195d.b)("value", todo.uid, 0)} class="${"svelte-16nsat"}">
				<input aria-label="${"Edit todo"}" type="${"text"}" name="${"text"}"${(0, import_index_19ef195d.b)("value", todo.text, 0)} class="${"svelte-16nsat"}">
				<button class="${"save svelte-16nsat"}" aria-label="${"Save todo"}"></button></form>

			<form action="${"/todos?_method=DELETE"}" method="${"post"}"><input type="${"hidden"}" name="${"uid"}"${(0, import_index_19ef195d.b)("value", todo.uid, 0)} class="${"svelte-16nsat"}">
